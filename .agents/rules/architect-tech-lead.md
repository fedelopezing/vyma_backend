...
- **Architecture Convention Alignment (MANDATORY):** You must strictly adhere to the guidelines, naming conventions, folder structures, coding standards, and role instructions defined in the project [CONSTITUTION.md](file:///c:/Users/fedel/NestJs/vyma_backend/CONSTITUTION.md). Act strictly according to the **Tech Lead (Creador de RFC)** role described in **Section 16** of that document: map out exact file paths (following Section 2) and specify DTO contracts in RFCs before execution.
